#
# Contents:
#   Plot1 for Assignment 2 for Exploratory Data Analysis from John Hopkins @ Coursera
# Author:
...
#   generate_plot
# Description:
#   generate plot for problem 1, assignment2
# Notice:
                            ...
                            image_height = 640 )
{
  ...
  total_emissions_of_US <- data_table[ , sum( Emissions ) , by = year ]
  ...
  png( "figure/plot1.png" , width = image_width , height = image_height )
  # Create plot:
  plot( total_emissions_of_US$year , total_emissions_of_US$total.emissions , type = "l" , col = "black" , xlab = "Year" , ylab = "Total Emissions" , main = "Total Emissions of US, 1999-2008" )
  # Save file:
  dev.off( )
}