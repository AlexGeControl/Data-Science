#
# Contents:
#   Plot5 for Assignment 2 for Exploratory Data Analysis from John Hopkins @ Coursera
# Author:
...
#   generate_plot
# Description:
#   generate plot for problem 5, assignment2
# Notice:
                           ...
                           image_height = 640 )
{
  ...
  png( "figure/plot5.png" , width = image_width , height = image_height )
  # Create plot:
  p <- qplot( year , total.emissions , data = total_emissions_of_Baltimore ,
              geom = "line" ,
              xlab = "Year" , ylab = "Total Emissions" , main = "Total Motor Vehicle Related Emissions of Baltimore, 1999-2008" )
  print( p )
  # Save file:
  dev.off( )
}